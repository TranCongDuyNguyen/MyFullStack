...
export default class ManagementControlPanel extends Component {
            ...
            <Container>
                <div className="led-container">
                    <Led className="blue-led"
                        ...
                        customShadow={run && "rgba(0, 0, 0, 0.2) 0 -1px 8px 1px, inset  0 -1px 9px, #3F8CFF 0 2px 14px"}
                        customShadowOfText={run && "0 0 0.4em 0.1em rgb(199, 255, 236)"}>
                        Run
                </Led>
                    <Led className="blue-led"
    ...
    componentDidUpdate() {
        socket.on("apiStatus", function (statusObj) {
